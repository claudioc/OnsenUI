...
class NavigatorElement extends BaseElement {
   ...
   * @description
   *   [en]Insert the specified pageUrl into the page stack with specified index. Extends pushPage parameters.[/en]
   ...
   * @type {HTMLElement}
   * @description
   *   [en]Current top page element. Use this method to access options passed by pushPage() or resetToPage() method.[/en]
